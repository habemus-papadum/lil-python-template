...
#
# Examples:
#   ./nb.sh docs/demos/01-basic.ipynb                    # Run notebook with default options
#   ./nb.sh --check-outputs docs/demos/02-intermediate.ipynb   # Run and check if outputs changed
#   ./nb.sh --no-inplace docs/demos/01-basic.ipynb       # Run without modifying the file
#   ./nb.sh docs/demos/01-basic.ipynb --ExecutePreprocessor.timeout=300
#
...
if [ $# -lt 1 ]; then
    ...
    echo ""
    echo "Examples:"
    echo "  ./nb.sh docs/demos/01-basic.ipynb"
    echo "  ./nb.sh --check-outputs docs/demos/02-intermediate.ipynb"
    echo "  ./nb.sh --no-inplace docs/demos/01-basic.ipynb"
    exit 1
fi
